...
// Release signing — key.properties is gitignored (never committed) and
// points at a keystore stored outside the repo entirely (see .gitignore).
// Falls back to debug signing if key.properties is missing (e.g. a fresh
// checkout on a machine that hasn't been given the keystore yet), so
...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.scanco.scanco"
