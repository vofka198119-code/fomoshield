...
// Same recipe as fund_management_screen.dart's own _chip helper (themedBorder
// ring + windowGradient fill on themed variants, flat accentPrimary@15% tint
// on Standard) -- the year picker that opens the bottom sheet.
class _YearPill extends StatelessWidget {
  final int year;
  final VoidCallback onTap;
  final AppPalette palette;

  const _YearPill({required this.year, required this.onTap, required this.palette});
