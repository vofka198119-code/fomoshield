...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get marketClockWindowEarlyCloseSessionStressTestPromoBody =>
      'Сокращённая, более быстрая сессия может показаться непривычной. Потренируйтесь в стресс-тесте — без реальных денег на кону, но с реальными рыночными условиями для обучения.';
  ...
  String get marketClockRiskClosedWhatToDo =>
      'Просмотрите свой портфель, почитайте отчёты компаний и подготовьте план на следующий торговый день. Также можно потренироваться в стресс-тесте, где каждая сделка симулируется и полностью независима от реального рынка.';
  ...
  String get marketClockRiskWeekendHolidayWhatToDo =>
      'Используйте возможность учиться без спешки. Изучайте новые компании, развивайте свои знания об инвестировании или тренируйтесь в стресс-тесте. Это безопасная среда, где можно укрепить уверенность, выработать дисциплину и проверить идеи без риска для реальных денег.';
  ...
  @override
  String get marketPeriodDetailOpenStressTestButton => 'Открыть стресс-тест';
